const heroDivinityData = {
  ...
  Poseidon: {
    branches: ['Immortality', 'Primeval', 'Asterial'],
    branchLeft: ['Transcend', 'Sunder', 'Recovery'],
    branchMiddle: ['Embroilment', 'Primal Totem', 'Colossus'],
    branchRight: ['Gemini', 'Black Hole', 'Spotlight'],
    notablesOrdered: [
      'Transcend',
      'Embroilment',
      'Gemini',
